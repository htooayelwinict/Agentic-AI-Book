...
ဒီအခန်းတွင် term အများကြီးထဲမှ MCP, Skill, Sub-agent သုံးခုကိုပဲ အဓိကခွဲမြင်ပါ။ MCP က connection layer ဖြစ်သည်။ Skill က instruction/manual ဖြစ်သည်။ Sub-agent က worker ဖြစ်သည်။ ကျန် term များကို ဒီသုံးခုကိုရှင်းရန်အတွက်သာ သုံးသွားမည်။
...
ဥပမာ - User က "မနက်ဖြန် meeting အတွက် GitHub issue summary နဲ့ agenda ပြင်ပေးပါ" ဟုမေးသည်ဆိုပါစို့။ MCP က GitHub, calendar, docs တို့ဆီ ချိတ်ရန်လမ်းပေးသည်။ Skill က meeting note ကိုဘယ်လိုရေးရမလဲဆိုသော လက်စွဲပေးသည်။ Sub-agent က issue list ဖတ်ပြီး summary ထုတ်သော အလုပ်ခွဲကိုလုပ်နိုင်သည်။

```text
MCP       = ပြင်ပကမ္ဘာသို့ ချိတ်သော connection
Skill     = Agent ဖတ်သော instruction/manual
Sub-agent = Main Agent က task ခွဲပေးသော worker
```
...
အလွယ်ပြောရလျှင် MCP server သည် tool/resource/prompt များကို စည်းကမ်းတကျဖွင့်ပေးသော service ဖြစ်သည်။ MCP client သည် Agent host ဘက်က ထို server ကိုခေါ်ရန်သုံးသော connector ဖြစ်သည်။ Schema ဆိုတာ tool ကို ဘယ် input ပုံစံနဲ့ခေါ်ရမလဲဆိုသော rule ဖြစ်သည်။
...
- GitHub issue ကိုဖတ်ခြင်း = Resource
- GitHub issue အသစ်ဖန်တီးခြင်း = Tool
- Issue reply style guide = Prompt
...
Skill file တစ်ခုသည် ဤလိုအကြမ်းဖျဉ်းဖြစ်နိုင်သည်။

- Goal: Playwright ဖြင့် webpage data ဖတ်ရန်
- Allowed tools: browser snapshot, click, text input
- Safety: login/payment/delete action မလုပ်ရန်
- Output: summary + source evidence
...
Skill loading တွင် အနည်းဆုံးမေးရမည့်မေးခွန်းများရှိသည်။

- Skill file သည် trusted directory မှလာသလား။
- Workspace skill က global skill ကို override လုပ်ခွင့်ရှိသလား။
- Skill content ကို signature/hash ဖြင့်စစ်ထားသလား။
- မကိုက်ညီလျှင် fail-open လုပ်မလား၊ fail-closed လုပ်မလား။
...
Context window ဆိုတာ model လက်ရှိမြင်နိုင်သော information ပမာဏဖြစ်သည်။ Compaction ဆိုတာ context ပြည့်လာသောအခါ အရေးကြီးသော rule များမပျောက်စေဘဲ ချုံ့သိမ်းခြင်းဖြစ်သည်။
...
အနှစ်ချုပ်ခွဲကြည့်လျှင် -

| Concept | အလွယ်မှတ်ရန် | အဓိက risk |
|---|---|---|
| MCP | ပြင်ပကမ္ဘာသို့တံတား | permission/auth/output risk |
| Skill | လက်စွဲစာအုပ် | malicious instruction risk |
| Sub-agent | အလုပ်ခွဲလက်ထောက် | context/tool scope leakage |
...
ဤ section ကို optional public context အဖြစ်ဖတ်ပါ။ OpenClaw, Pi, TUI, provider abstraction စသောနာမည်များကို အလွတ်မှတ်ရန်မလို။ အဓိကသင်ခန်းစာမှာ hype claim တစ်ခုကိုတွေ့သောအခါ source နှင့် boundary ကိုပြန်မေးရန်ဖြစ်သည်။
...
စာဖတ်သူအနေဖြင့် နာမည်များကိုအလွတ်ကျက်ရန်မလို။ မေးခွန်းသုံးခုကိုသာအမြဲမေးပါ။ "ဒီအရာက Agent ကို ဘာလုပ်ခွင့်ပေးသလဲ"။ "ဒီအရာက Agent ကို ဘာဖတ်ခွင့်ပေးသလဲ"။ "ဒီအရာက Agent ကို ဘာကိုမှတ်ထားစေသလဲ"။ ထိုမေးခွန်းများမေးတတ်လာလျှင် MCP, Skill, Sub-agent တို့သည် buzzwords မဟုတ်တော့ဘဲ အင်ဂျင်နီယာကိရိယာများဖြစ်လာလိမ့်မည်။
