...
မြန်မာလိုပြောလျှင် စားပွဲပေါ်တွင် လက်ရှိအလုပ်အတွက် မဖြစ်မနေလိုသော စည်းကမ်းစာရွက်များနှင့် လက်ဆွဲစာအုပ်ကို အမြဲထားနိုင်သည်။ သို့သော် စာအုပ်အပုံကြီးတစ်ခုလုံးကိုတော့ စားပွဲပေါ်တင်ထား၍မရပါ။

Context window လည်း ထိုနည်းတူဖြစ်သည်။ Agent အမြဲလိုအပ်သော rule, goal, constraint များကို context ထဲတွင်ထားသင့်သည်။ နမူနာအရှည်များ၊ reference အထူကြီးများ၊ history အဟောင်းများကိုတော့ လိုအပ်မှသာ Memory သို့မဟုတ် RAG မှ ပြန်ယူသင့်သည်။
