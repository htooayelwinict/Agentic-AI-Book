...
Beginner အနေနှင့် Harness ကို model ၏ အပြင်ဘက်က control layer လို့ အရင်မှတ်နိုင်သည်။ Model က "ဘာလုပ်ချင်တယ်" ဆိုတာကို ပြောသည်။ Harness က "လုပ်ခွင့်ရှိလား၊ ဘယ် tool နဲ့လုပ်မလဲ၊ log ဘယ်လိုသိမ်းမလဲ၊ risk ကြီးရင် လူကိုမေးမလား" ဆိုတာကို ထိန်းသည်။
